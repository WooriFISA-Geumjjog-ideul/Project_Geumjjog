	...
	<div class="main">
		<div class="container a-container" id="a-container">
			<form class="form" id="signupForm" method="post" action="">
				...
				<input class="form__input" type="text" name="mnickname" placeholder="닉네임">
				<input class="form__input" type="email" name="memail" placeholder="이메일">
				<button class="form__button button submit" onclick="signup()">회원가입</button>
			</form>
		</div>
