...
<body>
	<div class="main">
		<div class="container a-container" id="a-container">
			<form class="form" id="loginForm" method="post" action="loginProcess">
				<h2 class="form_title title">금쪽이들</h2>
				<input class="form__input" type="text" name="mname" placeholder="이름">
				<input class="form__input" type="password" name="mpw" placeholder="비밀번호">
				<a onclick="alert(1)">비밀번호찾기</a>
				<button class="form__button button submit" onclick="login()">로그인</button>
			</form>
		</div>
		<div class="container b-container" id="b-container">
			<form class="form" id="b-form" method="" action="">
				...
				<span class="form__span">or use your email account</span><input
					class="form__input" type="text" placeholder="Email"><input
					class="form__input" type="password" placeholder="Password"><a
		...
		<div class="switch" id="switch-cnt">
			...
			<div class="switch__container" id="switch-c1">
				...
				<button class="switch__button button switch-btn" onclick="location.href='signup'">회원가입</button>
			</div>
